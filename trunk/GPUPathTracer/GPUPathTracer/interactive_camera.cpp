...
void InteractiveCamera::changeAltitude(float x,float y){
	...
	glm::vec3 leftDirection = glm::cross(viewDirection,glm::vec3(0,1,0));
	glm::vec3 upDirection   = glm::cross(leftDirection,viewDirection);
	centerPosition = centerPosition + leftDirection * x + upDirection * y;
	//fixCenterPosition();
}
