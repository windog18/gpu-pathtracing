...
Image* PathTracer::render() {
	...
	launchKernel(singlePassImage->numPixels ,singlePassImage->pixels  ,device_materialList, image->passCounter, *renderCamera); // Dereference not ideal.
